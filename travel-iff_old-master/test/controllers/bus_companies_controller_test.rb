...
class BusCompaniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus_company" do
    assert_difference('BusCompany.count') do
      post bus_companies_url, params: { bus_company: { cnpj: @bus_company.cnpj, name: @bus_company.name } }
    end
  ...
  test "should update bus_company" do
    patch bus_company_url(@bus_company), params: { bus_company: { cnpj: @bus_company.cnpj, name: @bus_company.name } }
